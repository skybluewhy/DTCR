...
def fori_loop(lower, upper, body_fun, init_val, att, mutation, target):
    val = init_val
    for i in range(lower, upper):
        val, att, mutation, target = body_fun(i, val, att, mutation, target)
    return val


def fori_loop_reinforce_learn(lower, upper, body_fun, init_val, att, target):
    val = init_val
    for i in range(lower, upper):
