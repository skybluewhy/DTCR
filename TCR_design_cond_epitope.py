...
# python TCR_design_cond_epitope.py --seed_num 20 --batch_size 1024 --model_path "./checkpoint/model_design6.th" --schedule_name 'blosum' --schedule exp --use_pred 1
# python TCR_design_cond_epitope_reinforce_infer.py --seed_num 20 --batch_size 1024 --model_path "./checkpoint/model_design19.th" --schedule_name 'random' --schedule mutual --use_pred 1
